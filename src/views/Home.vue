  ...
  <main class="home-page">
    <b-container class="crud-action-panel">
      <b-form-row>
        ...
        <b-col md="3">
          <b-button variant="primary" class="mb-2" @click="addProject">
            Add project
          </b-button>
        </b-col>
      ...
      <b-row v-if="projects.length">
        ...
        >
          <b-card header-tag="header" footer-tag="footer">
            ...
            <span slot="footer" class="delete-btn" @click="rmvPortfolioItem(index)">
              Delete Project
            </span>
          </b-card>
        </b-col>
  ...
  computed: {
    filteredProjects() {
      return this.projects.filter(
        project => project.name.toLowerCase().indexOf(this.searchQuery.toLowerCase()) > -1
      );
    }
  },
  methods: {
